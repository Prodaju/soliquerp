...
// Query to retrieve users and their scores
...
if ($result && mysqli_num_rows($result) > 0) {
    // Data fetch successful, proceed with displaying leaderboard
} else {
    // No data retrieved, handle this case (display message, etc.)
}
